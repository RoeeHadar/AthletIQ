...
- **2026-08-16** · `SOURCE: agent` · **WHY:** CR-005 Gate 6 IMP-019–025 Done after remote CI. **HOW:** Live NBA player boxes remain on the same `nba-stats` host. Adapter shape: `integration-invariants`. Do not send RapidAPI / Highlightly / BALLDONTLIE / API-Sports signup URLs. Live WNBA HTTP is **out**. Live pin publish is operator (`engineering-lifecycle`).
