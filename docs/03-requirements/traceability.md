...
IMP-001…012 **Done** is Gate 6 code complete for listed MVP modules. IMP-013–018 (CR-004) are **Done**: CI `491c5c0` ([31913410157](https://github.com/RoeeHadar/AthletIQ/actions/runs/31913410157)); code review APPROVE 2026-08-16 (`docs/00-meta/reviews/2026-08-16-cr004-code-review.md`). IMP-019–025 (CR-005) are **Not started** — do not mark Implementation=`Implemented` until those IMP Status values are Done.
...
|---|---|---|---|---|---|---|---|
| FR-001 | system/data | error + ADR-006 | IMP-003, IMP-020 | TEST-003, TEST-020, TEST-025 | Amended (CR-005) | Partial | Passing (local) / Planned |
| FR-002 | data | database | IMP-002, IMP-004, IMP-019 | TEST-002, TEST-004 | Amended (CR-005) | Partial | Passing (local) / Passing (in-memory) / Planned |
...
| FR-015 | api | PRODUCT.md + gamecast Comp A | IMP-018, IMP-023 | TEST-008, TEST-019, TEST-028 | Amended (CR-005) | Partial | Passing (local) / Planned |
| FR-016 | data | database | IMP-014, IMP-021 | TEST-015, TEST-026 | Amended (CR-005) | Partial | Passing (local) / Planned |
| FR-017 | data | database | IMP-014, IMP-020 | TEST-016, TEST-025 | Amended (CR-005) | Partial | Passing (local) / Planned |
...
| FR-021 | data | database + ADR-015 | IMP-019, IMP-020, IMP-021 | TEST-020, TEST-025 | Active | Not started | Planned |
| FR-022 | data/api | database + ADR-014 | IMP-019, IMP-023 | TEST-022, TEST-023 | Active | Not started | Planned |
| FR-023 | system/data | database + api + ADR-015 | IMP-019, IMP-022, IMP-023 | TEST-021, TEST-022 | Active | Not started | Planned |
| FR-024 | api | api + ADR-016 | IMP-023 | TEST-023, TEST-028 | Active | Not started | Planned |
| FR-025 | api | api + ADR-016 | IMP-023 | TEST-024, TEST-028 | Active | Not started | Planned |
| FR-026 | system | infrastructure + ADR-015 | IMP-022 | TEST-024, TEST-025 | Active | Not started | Planned |
| FR-027 | data | database + ADR-017 | IMP-020 | TEST-025, TEST-016 | Active | Not started | Planned |
| FR-028 | system | ml + model-card | IMP-024 | TEST-007, TEST-027 | Active | Not started | Planned |
| DR-001 | data | ml | IMP-003, IMP-004, IMP-014, IMP-020, IMP-021 | TEST-003, TEST-004, TEST-015, TEST-025, TEST-026 | Amended (CR-005) | Partial | Passing (local) / Planned |
| DR-002 | data | database | IMP-002, IMP-004, IMP-013, IMP-019 | TEST-002, TEST-004, TEST-015, TEST-022 | Amended (CR-005) | Partial | Passing (local) / Planned |
| DR-003 | data | database | IMP-004, IMP-014, IMP-022 | TEST-004, TEST-016, TEST-017, TEST-021 | Amended (CR-005) | Partial | Passing (local) / Planned |
| DR-004 | data | database | IMP-013, IMP-014 | TEST-017 | Active | Implemented | Passing (local) |
| DR-005 | data | database + ADR-014 | IMP-019 | TEST-002, TEST-021, TEST-022 | Active | Not started | Planned |
| DR-006 | data | database + ADR-015 | IMP-019, IMP-020 | TEST-020, TEST-021, TEST-024 | Active | Not started | Planned |
...
| ML-005 | system | ml | IMP-007, IMP-024 | TEST-007 (quality gate), TEST-027 | Amended (CR-005) | Partial | Passing (synthetic) / Planned |
...
| ML-012 | system | ml + model-card | IMP-024 | TEST-027 | Active | Not started | Planned |
...
| NFR-003 | system | ci-cd | IMP-011, IMP-025 | TEST-011, TEST-025 | Active | Implemented | Passing (local) / Planned |
| NFR-004 | api | api | IMP-008 | TEST-008 | Active | Implemented | Passing (local) |
| NFR-005 | data | database | IMP-002, IMP-019 | TEST-002, TEST-022 | Amended (CR-005) | Partial | Passing (local) / Planned |
...
| CON-009 | api | api + ADR-012 + ADR-014 | IMP-017, IMP-018, IMP-023 | TEST-017, TEST-019, TEST-021, TEST-024, TEST-028 | Amended (CR-005) | Partial | Passing (local) / Planned |
...
| ADR-014 | data/api | ADR-014 | IMP-019, IMP-023 | TEST-021, TEST-022 | Accepted | Not started | Planned |
| ADR-015 | system/data | ADR-015 | IMP-019, IMP-020, IMP-022 | TEST-020, TEST-021, TEST-024 | Accepted | Not started | Planned |
| ADR-016 | api | ADR-016 | IMP-023 | TEST-023, TEST-024, TEST-028 | Accepted | Not started | Planned |
| ADR-017 | data | ADR-017 | IMP-020, IMP-024 | TEST-025, TEST-027 | Accepted | Not started | Planned |
...
- DR-001 Implementation **Partial** (CR-005: live uncapped + WNBA 2021–2025/2026 scheduled not in code yet). TEST-003/004 remain fixture/in-memory. Owner-reported **local live** ingest **2026-08-14** (`--provider nba-stats --seasons 2023 2024`, **2640** games) is a CR-004-era two-season run — **not** CR-005 DR-001 done and not a PRD tick.  
